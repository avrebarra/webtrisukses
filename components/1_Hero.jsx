          ...
          >
            <div className=" flex flex-col justify-center items-start row-start-2 sm:row-start-1">
              ...
              <p className="text-slate-900 mt-4 mb-6">
                Anda dapat mengandalkan kami dalam hal <strong>kontraktor</strong> jasa bangun dan jasa renovasi rumah tinggal, rumah kos, ruko,
                kantor, gudang, sipil, interior, café dan lainnya.
              </p>
            ...
            <div className="flex w-full">
              <motion.div className="h-full w-full" variants={scrollAnimation}>
                <Image src="/assets/hero2.png" alt="VPN Illustrasi" quality={100} width={450} height={383} layout="responsive" />
              </motion.div>
            </div>
          </motion.div>
        </ScrollAnimationWrapper>
