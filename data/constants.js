export const PHONE_NUMBER = "6282257460176";
export const EMAIL = "tris.bangunkarya@gmail.com";
export const ADDRESS = "Jl Teluk Bayur RT02 RW01 Kelurahan Gebang Sidoarjo, Jawa Timur";
export const WHATSAPP_MESSAGES = {
  GENERAL: `https://api.whatsapp.com/send?phone=${PHONE_NUMBER}&text=${encodeURIComponent("Halo, saya tertarik dengan CV Trisukses Bangun Karya dan ingin bertanya mengenai jasa yang ditawarkan")}`,
  BANGUN_RUMAH: `https://api.whatsapp.com/send?phone=${PHONE_NUMBER}&text=${encodeURIComponent("Halo, saya ingin bertanya mengenai jasa BANGUN RUMAH di CV Trisukses Bangun Karya?")}`,
  RENOVASI_RUMAH: `https://api.whatsapp.com/send?phone=${PHONE_NUMBER}&text=${encodeURIComponent("Halo, saya ingin bertanya mengenai jasa RENOVASI RUMAH di CV Trisukses Bangun Karya?")}`,
  ...
  BANGUN_RUMAH_BANGUN_TOKO: `https://api.whatsapp.com/send?phone=${PHONE_NUMBER}&text=${encodeURIComponent("Halo, saya ingin bertanya mengenai jasa BANGUN TOKO di CV Trisukses Bangun Karya.")}`,
  RENOVASI_MENINGKAT_RUMAH: `https://api.whatsapp.com/send?phone=${PHONE_NUMBER}&text=${encodeURIComponent("Halo, saya ingin bertanya mengenai jasa RENOVASI MENINGKAT RUMAH di CV Trisukses Bangun Karya.")}`,
  RENOVASI_PENGECATAN: `https://api.whatsapp.com/send?phone=${PHONE_NUMBER}&text=${encodeURIComponent("Halo, saya ingin bertanya mengenai jasa RENOVASI PENGECATAN di CV Trisukses Bangun Karya.")}`,
  RENOVASI_RENOVASI_RUMAH_LAINNYA: `https://api.whatsapp.com/send?phone=${PHONE_NUMBER}&text=${encodeURIComponent("Halo, saya ingin bertanya mengenai jasa RENOVASI RENOVASI RUMAH LAINNYA di CV Trisukses Bangun Karya.")}`,
  ...
  MAINTENANCE_INSTALASI_CCTV: `https://api.whatsapp.com/send?phone=${PHONE_NUMBER}&text=${encodeURIComponent("Halo, saya ingin bertanya mengenai jasa MAINTENANCE INSTALASI CCTV di CV Trisukses Bangun Karya.")}`,
  MAINTENANCE_PASANG_KITCHEN_SET: `https://api.whatsapp.com/send?phone=${PHONE_NUMBER}&text=${encodeURIComponent("Halo, saya ingin bertanya mengenai jasa MAINTENANCE PASANG KITCHEN SET di CV Trisukses Bangun Karya.")}`,
};
